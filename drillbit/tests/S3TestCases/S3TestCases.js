...
 putObjectCopy_as_async: function (callback){
    AWS.S3.putObjectCopy({'bucketName':'pankaj2344','objectName':'xyz','copySource':'/test12398/strus2.pdf'},function(data){
     callback.failed('Some error occured');
    }, function (error){
        callback.passed();   
    });
 ...
    AWS.S3.putObjectCopy({'bucketName':'invalid','objectName':'xyz','copySource':'/test12398/strus2.pdf'},function(data){
     callback.failed('Some error occured');
    }, function (error){
        callback.passed();   
    });
 ...
    AWS.S3.putObjectCopy({'bucketName':'','objectName':'xyz','copySource':'/test12398/strus2.pdf'},function(data){
     callback.failed('Some error occured');
    }, function (error){
        callback.passed();   
    });
 ...
    AWS.S3.putObjectCopy({'bucketName':'pankaj2344','objectName':'','copySource':'/test12398/strus2.pdf'},function(data){
     callback.failed('Some error occured');
    }, function (error){
        callback.passed();   
    });
 ...
    AWS.S3.putObjectCopy({'bucketName':'pankaj2344','objectName':'validname','copySource':''},function(data){
     callback.failed('Some error occured');
    }, function (error){
        callback.passed();   
    });
 ...
    AWS.S3.putObjectCopy({'bucketName':'pankaj2344','objectName':'validname','copySource':'xyzw'},function(data){
     callback.failed('Some error occured');
    }, function (error){
        callback.passed();   
    });
 ...
    AWS.S3.getObjectTorrent({'bucketName':'test12398','objectName':'Rahul.png'},function(data){
    callback.passed();    
    }, function (error){
        callback.failed('Some error occured');
    });
...
getObjectTorrentWithEmptyBucketName_as_async: function (callback){
    AWS.S3.getObjectTorrent({'bucketName':'','objectName':'Spring.pdf'},function(data){
...
getObjectTorrentWithInvalidBucketName_as_async: function (callback){
    AWS.S3.getObjectTorrent({'bucketName':'xyzw','objectName':'Spring.pdf'},function(data){
     callback.failed('Some error occured');
    }, function (error){
        callback.passed();   
    });
...
getObjectTorrentWithInvalidObjectName_as_async: function (callback){
    AWS.S3.getObjectTorrent({'bucketName':'pankaj2344','objectName':'image'},function(data){
     callback.failed('Some error occured');
    }, function (error){
        callback.passed();   
    });
  },
	...
	   AWS.S3.initiateMultipartUpload({'bucketName':'test12398','objectName':'struts2.pdf'},function(data){
...
uploadPartCopy_as_async: function (callback){
	...
	AWS.S3.uploadPartCopy({'bucketName':'test12398','objectName':'struts2.pdf','copySource':'/pankaj2344/Spring.pdf','uploadId': uploadId,'partNumber':'2'},function(data){
		ETag= data.ETag;
   callback.passed();    
   }, function (error){
       callback.failed('Some error occured');
...
   AWS.S3.initiateMultipartUpload({'bucketName':'','objectName':'Rahul.png'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.initiateMultipartUpload({'bucketName':'xyzw','objectName':'Rahul.png'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.initiateMultipartUpload({'bucketName':'test12398','objectName':''},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.initiateMultipartUpload({'bucketName':'test12398','objectName':'xyz'},function(data){
       callback.passed();      
   }, function (error){
callback.failed('Some error occured');
   });
...
   AWS.S3.listParts({'bucketName':'test12398','objectName':'Rahul.png','uploadId':'WDy5XnIR1AM6mo1yYTOCfNvkNxSCv4OW8vlMCbHAc2Se6XKkXFRlv_nKIY7IQ3PM0DSzWiSyodqcUC8V.lhufQ--'},function(data){
   callback.passed();    
   }, function (error){
       callback.failed('Some error occured');
   });
...
   AWS.S3.listParts({'bucketName':'','objectName':'Rahul.png','uploadId':'WDy5XnIR1AM6mo1yYTOCfNvkNxSCv4OW8vlMCbHAc2Se6XKkXFRlv_nKIY7IQ3PM0DSzWiSyodqcUC8V.lhufQ--'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.listParts({'bucketName':'xyzw','objectName':'Rahul.png','uploadId':'WDy5XnIR1AM6mo1yYTOCfNvkNxSCv4OW8vlMCbHAc2Se6XKkXFRlv_nKIY7IQ3PM0DSzWiSyodqcUC8V.lhufQ--'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.listParts({'bucketName':'test12398','objectName':'','uploadId':'WDy5XnIR1AM6mo1yYTOCfNvkNxSCv4OW8vlMCbHAc2Se6XKkXFRlv_nKIY7IQ3PM0DSzWiSyodqcUC8V.lhufQ--'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.listParts({'bucketName':'test12398','objectName':'imag','uploadId':'WDy5XnIR1AM6mo1yYTOCfNvkNxSCv4OW8vlMCbHAc2Se6XKkXFRlv_nKIY7IQ3PM0DSzWiSyodqcUC8V.lhufQ--'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.listParts({'bucketName':'test12398','objectName':'Rahul.png','uploadId':''},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'','objectName':'struts2.pdf','copySource':'/pankaj2344/Spring.pdf','uploadId':uploadId,'partNumber':'1'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'xyzw','objectName':'struts2.pdf','copySource':'/pankaj2344/Spring.pdf','uploadId':uploadId,'partNumber':'1'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'test12398','objectName':'','copySource':'/pankaj2344/Spring.pdf','uploadId':uploadId,'partNumber':'1'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'test12398','objectName':'image.63','copySource':'/pankaj2344/Spring.pdf','uploadId':uploadId,'partNumber':'1'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'test12398','copySource':'/pankaj2344/Spring.pdf','objectName':'struts2.pdf','uploadId':'','partNumber':'1'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'test12398','objectName':'struts2.pdf','copySource':'/pankaj2344/Spring.pdf','uploadId':'','partNumber':'1'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'test12398','objectName':'struts2.pdf','copySource':'/pankaj2344/Spring.pdf','uploadId':uploadId,'partNumber':''},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'test12398','objectName':'struts2.pdf','copySource':'/pankaj2344/Spring.pdf','uploadId':uploadId,'partNumber':'xy'},function(data){
    callback.failed('Some error occured');
   }, function (error){
       callback.passed();  
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'test12398','objectName':'struts2.pdf','copySource':'','uploadId':uploadId,'partNumber':'2'},function(data){
   callback.failed('Some error occured');    
   }, function (error){
       callback.passed();
   });
...
   AWS.S3.uploadPartCopy({'bucketName':'test12398','objectName':'struts2.pdf','copySource':'/blah/blah','uploadId':uploadId,'partNumber':'2'},function(data){
   callback.failed('Some error occured');  
   }, function (error){
       callback.passed();
   });
